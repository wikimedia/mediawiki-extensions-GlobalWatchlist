 ...
 *
 * - For Special:GlobalWatchlistSettings when filling in the defaults of the HTMLForm from saved settings,
 *   but the PHP code had a problem decoding the settings (see FormatJson::parse)
 *
