( function () {
	...
	const GlobalWatchlistWatchlistUtils = require( '../../../modules/WatchlistUtils.js' );
	...
	const GlobalWatchlistEntryBase = require( '../../../modules/EntryBase.js' );
	...
	const watchlistUtils = new GlobalWatchlistWatchlistUtils(
